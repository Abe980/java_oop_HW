...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4 = new HotDrink(180, 4, "Cappuccino", 204, 70);
        Product item5 = new HotDrink(160, 5, "Espresso", 205, 80);
        Product item6 = new HotDrink(100, 6, "Tea", 206);


        assort.add(item1);
        assort.add(item2);
        assort.add(item3);
        // добавляем горячие напитки в аппарат
        assort.add(item4);
        assort.add(item5);
        assort.add(item6);
